...
5. If :math:`\lambda` is zero and there is a boundary species present then one can use the details described in :ref:`my-injectivity-label` to conduct further analysis of the network.
